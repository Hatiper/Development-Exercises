...
//  Out OF The World
//
//  Created by 001756 on 28/05/14.
//  Copyright (c) 2014 MuzafferHatiper. All rights reserved.
//
...
- (void)viewDidLoad
{
    ...
    NSString *planet1=@"lckldjgl";
    NSString *planet2=@"lckldjglhg";
    NSString *planet3=@"lckldjglghg";
    NSString *planet4=@"lckldjglghgh";
    NSString *planet5=@"lckldjglghghgh";
    NSString *planet6=@"lckldjglghghg";
    NSString *planet7=@"lckldjglghg";
    NSString *planet8=@"lckldjglgh";
    NSString *planet9=@"lckldjgl";
